...
/*
 *---------------------------------------------------------------
 * SAISAI INSTALL DIRECTORY
 *---------------------------------------------------------------
 *
 * This is the directory path to the saisai installation folder
 *
 */
define('INSTALL_ROOT', str_replace('\\', '/', realpath(dirname(__FILE__))).'/saisai/');


/*
 *---------------------------------------------------------------
 * SAISAI CLI (Command Line Interface)
 *---------------------------------------------------------------
 *
...
if (defined('STDIN'))
{
	/* if your SAISAI installation exists in a subfolder, then you may want to change SCRIPT_NAME to /subfolder/index.php
