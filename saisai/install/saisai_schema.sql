...
# Dump of table saisai_categories
# ------------------------------------------------------------
...
# Dump of table saisai_navigation
# ------------------------------------------------------------
...
# Dump of table saisai_navigation_groups
# ------------------------------------------------------------
...
INSERT INTO `saisai_navigation_groups` (`id`, `name`, `published`)
VALUES
	(1, 'main', 'yes');



# Dump of table saisai_page_variables
# ------------------------------------------------------------
...
# Dump of table saisai_permissions
# ------------------------------------------------------------
...
LOCK TABLES `saisai_permissions` WRITE;
/*!40000 ALTER TABLE `saisai_permissions` DISABLE KEYS */;

INSERT INTO `saisai_permissions` (`id`, `description`, `name`, `active`)
VALUES
...
/*!40000 ALTER TABLE `saisai_permissions` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table saisai_relationships
# ------------------------------------------------------------
...
# Dump of table saisai_site_variables
# ------------------------------------------------------------
