...
-- 
-- Database: `saisai_widgicorp`
-- 

-- --------------------------------------------------------

-- 
-- Table structure for table `saisai_archives`
-- 
DROP TABLE IF EXISTS `saisai_archives`;
CREATE TABLE `saisai_archives` (
...
-- 
-- Dumping data for table `saisai_archives`
-- 

-- --------------------------------------------------------

-- 
-- Table structure for table `saisai_blocks`
-- 
DROP TABLE IF EXISTS `saisai_blocks`;
CREATE TABLE `saisai_blocks` (
...
-- 
-- Dumping data for table `saisai_blocks`
-- 

INSERT INTO `saisai_blocks` (`id`, `name`, `view`, `published`, `date_added`, `last_modified`) VALUES
(2, 'quote', '{$quote = saisai_model(''quotes'', array(''find'' = ''one'', ''order'' = ''RAND()''))}\n{if ($quote) }\n<div id="block_quote">\n	{quote($quote->content, $quote->name, $quote->title)}\n</div>\n{/if}', 'no', '2010-11-06 18:34:33', '2010-11-07 01:47:36'),
(3, 'showcase', '{$project = saisai_model(''projects'', array(''find'' = ''one'', ''where'' = array(''featured'' = ''yes''), ''order'' = ''RAND()''))}\n\n{if ($project) }\n<div id="block_showcase">\n	<h3>{$project->name}</h3>\n	<img src="{$project->image_path}" />\n</div>\n{/if}', 'yes', '2010-11-06 18:34:58', '2010-11-07 01:14:08');

-- --------------------------------------------------------

-- 
-- Table structure for table `saisai_blog_categories`
-- 
DROP TABLE IF EXISTS `saisai_blog_categories`;
CREATE TABLE `saisai_blog_categories` (
  `id` int(10) unsigned NOT NULL auto_increment,
...
-- 
-- Dumping data for table `saisai_blog_categories`
-- 

INSERT INTO `saisai_blog_categories` (`id`, `name`, `permalink`, `published`) VALUES
...
-- 
-- Table structure for table `saisai_blog_comments`
-- 
DROP TABLE IF EXISTS `saisai_blog_comments`;
CREATE TABLE `saisai_blog_comments` (
  `id` int(10) unsigned NOT NULL auto_increment,
...
-- 
-- Dumping data for table `saisai_blog_comments`
-- 

INSERT INTO `saisai_blog_comments` (`id`, `post_id`, `parent_id`, `author_id`, `author_name`, `author_email`, `author_website`, `author_ip`, `is_spam`, `content`, `published`, `date_added`, `last_modified`) VALUES
...
-- 
-- Table structure for table `saisai_blog_links`
-- 

DROP TABLE IF EXISTS `saisai_blog_links`;
CREATE TABLE `saisai_blog_links` (
...
-- 
-- Dumping data for table `saisai_blog_links`
-- 

INSERT INTO `saisai_blog_links` (`id`, `name`, `url`, `target`, `description`, `precedence`, `published`) VALUES
...
-- 
-- Table structure for table `saisai_blog_posts`
-- 

DROP TABLE IF EXISTS `saisai_blog_posts`;
CREATE TABLE `saisai_blog_posts` (
  `id` int(10) unsigned NOT NULL auto_increment,
...
-- 
-- Dumping data for table `saisai_blog_posts`
-- 

INSERT INTO `saisai_blog_posts` (`id`, `title`, `content`, `content_filtered`, `formatting`, `excerpt`, `permalink`, `author_id`, `sticky`, `allow_comments`, `date_added`, `last_modified`, `published`) VALUES
...
-- 
-- Table structure for table `saisai_blog_posts_to_categories`
-- 

DROP TABLE IF EXISTS `saisai_blog_posts_to_categories`;
CREATE TABLE `saisai_blog_posts_to_categories` (
  `post_id` int(10) unsigned NOT NULL,
...
-- 
-- Dumping data for table `saisai_blog_posts_to_categories`
-- 

INSERT INTO `saisai_blog_posts_to_categories` (`post_id`, `category_id`) VALUES
(1, 1);

-- --------------------------------------------------------

-- 
-- Table structure for table `saisai_blog_settings`
-- 

DROP TABLE IF EXISTS `saisai_blog_settings`;
CREATE TABLE `saisai_blog_settings` (
  `name` varchar(100) collate utf8_unicode_ci NOT NULL,
...
-- 
-- Dumping data for table `saisai_blog_settings`
-- 

INSERT INTO `saisai_blog_settings` (`name`, `value`) VALUES
('title', 'My Blog'),
('uri', 'blog/'),
('theme_layout', 'blog'),
...
-- 
-- Table structure for table `saisai_blog_users`
-- 

DROP TABLE IF EXISTS `saisai_blog_users`;
CREATE TABLE `saisai_blog_users` (
  `saisai_user_id` int(10) unsigned NOT NULL,
  ...
  PRIMARY KEY  (`saisai_user_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

-- 
-- Dumping data for table `saisai_blog_users`
-- 

INSERT INTO `saisai_blog_users` (`saisai_user_id`, `display_name`, `website`, `about`, `avatar_image`, `twitter`, `facebook`, `date_added`, `active`) VALUES
(1, '', '', '', 'team_placeholder.png', '', '', '2010-11-07 12:14:53', 'yes');

-- --------------------------------------------------------

-- 
-- Table structure for table `saisai_logs`
-- 

DROP TABLE IF EXISTS `saisai_logs`;
CREATE TABLE `saisai_logs` (
  `id` int(10) unsigned NOT NULL auto_increment,
...
-- 
-- Dumping data for table `saisai_logs`
-- 

-- --------------------------------------------------------

-- 
-- Table structure for table `saisai_navigation`
-- 

DROP TABLE IF EXISTS `saisai_navigation`;
CREATE TABLE `saisai_navigation` (
  `id` int(10) unsigned NOT NULL auto_increment,
...
-- 
-- Dumping data for table `saisai_navigation`
-- 
...
-- 
-- Table structure for table `saisai_navigation_groups`
-- 

DROP TABLE IF EXISTS `saisai_navigation_groups`;
CREATE TABLE `saisai_navigation_groups` (
...
-- 
-- Dumping data for table `saisai_navigation_groups`
-- 
...
-- 
-- Table structure for table `saisai_pages`
-- 

DROP TABLE IF EXISTS `saisai_pages`;
CREATE TABLE `saisai_pages` (
  `id` int(10) unsigned NOT NULL auto_increment,
...
-- 
-- Dumping data for table `saisai_pages`
-- 

INSERT INTO `saisai_pages` (`id`, `location`, `layout`, `published`, `cache`, `date_added`, `last_modified`, `last_modified_by`) VALUES
(1, 'about', 'main', 'yes', 'yes', '2010-11-06 17:43:03', '2010-11-07 10:14:14', 1);

-- --------------------------------------------------------

-- 
-- Table structure for table `saisai_page_variables`
-- 

DROP TABLE IF EXISTS `saisai_page_variables`;
CREATE TABLE `saisai_page_variables` (
  `id` int(10) unsigned NOT NULL auto_increment,
...
-- 
-- Dumping data for table `saisai_page_variables`
-- 

INSERT INTO `saisai_page_variables` (`id`, `page_id`, `name`, `scope`, `value`, `type`, `active`) VALUES
...
-- 
-- Table structure for table `saisai_permissions`
-- 

DROP TABLE IF EXISTS `saisai_permissions`;
CREATE TABLE `saisai_permissions` (
  `id` int(10) unsigned NOT NULL auto_increment,
...
-- 
-- Dumping data for table `saisai_permissions`
-- 

INSERT INTO `saisai_permissions` (`id`, `name`, `description`, `active`) VALUES
...
-- 
-- Table structure for table `saisai_site_variables`
-- 

DROP TABLE IF EXISTS `saisai_site_variables`;
CREATE TABLE `saisai_site_variables` (
  `id` int(10) unsigned NOT NULL auto_increment,
  `name` varchar(100) collate utf8_unicode_ci NOT NULL,
  `value` text collate utf8_unicode_ci NOT NULL,
...
-- 
-- Dumping data for table `saisai_site_variables`
-- 
...
-- 
-- Table structure for table `saisai_users`
-- 

DROP TABLE IF EXISTS `saisai_users`;
CREATE TABLE `saisai_users` (
  `id` int(10) unsigned NOT NULL auto_increment,
...
-- 
-- Dumping data for table `saisai_users`
-- 

INSERT INTO `saisai_users` (`id`, `user_name`, `password`, `email`, `first_name`, `last_name`, `super_admin`, `active`) VALUES
(1, 'admin', '21232f297a57a5a743894a0e4a801fc3', '', 'Admin', '', 'yes', 'yes');

-- --------------------------------------------------------

-- 
-- Table structure for table `saisai_user_to_permissions`
-- 

DROP TABLE IF EXISTS `saisai_user_to_permissions`;
CREATE TABLE `saisai_user_to_permissions` (
...
-- 
-- Dumping data for table `saisai_user_to_permissions`
-- 
INSERT INTO `saisai_user_to_permissions` (`user_id`, `permission_id`) VALUES
(2, 1),
(2, 2),
(2, 3),
(2, 4),
