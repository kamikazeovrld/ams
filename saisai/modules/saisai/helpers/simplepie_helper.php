 ...
 * @category	Helpers
 * @author		David McReynolds @ Daylight Studio
 * @link		http://docs.getsaisaicms.com/helpers/simplepie_helper
 */
...
function simplepie($feed, $limit = 5, $params = array())
{
	...
	$CI->load->module_library(SAISAI_FOLDER, 'simplepie');
	...
	$latest_saisai_version = $CI->simplepie->get_channel_tags('', 'latestSaisaiVersion');
	if ( ! is_null($latest_saisai_version[0]))
	{
		$feed_data['latest_saisai_version'] = $latest_saisai_version[0]['data'];
	}
	return $feed_data;
}
...
/* Location: ./modules/saisai/helpers/simplepie_helper.php */