 ...
 * @category	Helpers
 * @author		David McReynolds @ Daylight Studio
 * @link		http://docs.getsaisaicms.com/helpers/my_language_helper
 */
...
{
	$CI =& get_instance();
	return $CI->saisai->language->detect($set_config);
}

/* End of file MY_language_helper.php */
/* Location: ./modules/saisai/helpers/MY_language_helper.php */