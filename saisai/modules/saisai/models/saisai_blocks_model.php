 ...
 *
 * <strong>Saisai_blocks_model</strong> is used for managing CMS administrable blocks
 * 
 * @package		SAISAI CMS
 * @subpackage	Models
 * @category	Models
 * @author		David McReynolds @ Daylight Studio
 * @link		http://docs.getsaisaicms.com/models/saisai_blocks_model
 */

require_once('base_module_model.php');

class Saisai_blocks_model extends Base_module_model {
	...
	{
		parent::__construct('saisai_blocks');
	}
...
class Saisai_block_model extends Base_module_record {
}
