 ...
 *
 * <strong>Saisai_relationships_model</strong> is used for managing SAISAI users in the CMS
 * 
 * @package		SAISAI CMS
 * @subpackage	Models
 * @category	Models
 * @author		David McReynolds @ Daylight Studio
 * @link		http://docs.getsaisaicms.com/models/saisai_relationships_model
 */

require_once('base_module_model.php');

class Saisai_relationships_model extends Base_module_model {
	...
	{
		parent::__construct('saisai_relationships');
	}
...
class Saisai_relationship_model extends Base_module_record {
}