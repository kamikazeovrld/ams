...
|--------------------------------------------------------------------------
*/
$lang['saisai_page_title'] = 'SAISAI CMS';
$lang['logged_in_as'] = 'Logged in as:';
$lang['logout'] = 'Logout';
$lang['saisai_developed_by'] = 'SAISAI CMS version %1s is developed by <a href="http://www.thedaylightstudio.com" target="_blank">Daylight Studio</a> and built upon the <a href="http://www.codeigniter.com" target="_blank">CodeIgniter</a> framework.';
$lang['saisai_copyright'] = 'Copyright &copy; %1s Daylight Studio. All Rights Reserved.';
...
$lang['dashboard_intro'] = 'Welcome to SAISAI CMS.';
$lang['dashboard_hdr_latest_activity'] = 'Latest Activity';
$lang['dashboard_hdr_latest_news'] = 'Latest SAISAI News';
...
$lang['pwd_reset_subject'] = "SAISAI admin password reset request";
$lang['pwd_reset_email'] = "Click the following link to confirm the reset of your SAISAI password:\n%1s";
$lang['pwd_reset_subject_success'] = "SAISAI admin password reset success";
$lang['pwd_reset_email_success'] = "Your SAISAI password has been reset to %1s. To change your password, login to the SAISAI CMS admin with this password and click on your login name in the upper right to access your profile information.";
...
$lang['module_incompatible'] = 'The version of this module is not compatible with the install SAISAI version of '.SAISAI_VERSION;
...
$msg = "The module %1s has been uninstalled in SAISAI.\n\n";
...
$lang['new_user_email_subject'] = 'Your SAISAI CMS account has been created';
$lang['new_user_email'] = 'Your SAISAI CMS account has been created. You can login with the following information:
Login URL: %1s
User name: %2s
Password: %3s';
...
|--------------------------------------------------------------------------
*/
$lang['permissions_instructions'] = 'Here you can manage the permissions for SAISAI modules and later assign them to users.';
...
$lang['settings_problem'] = 'There was a problem with the settings for the advanced module <strong>%1s</strong>. <br />Check that <strong>/saisai/modules/%1s/config/%1s.php</strong> config is configured to handle settings.';
...
include('saisai_js_lang.php');

/* End of file saisai_lang.php */
/* Location: ./modules/saisai/language/english/saisai_lang.php */