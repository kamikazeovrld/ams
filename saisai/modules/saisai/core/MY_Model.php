...
class MY_Model extends CI_Model {
	...
	public function __construct($table = NULL, $params = array())
	{
		...
		$this->load->module_language(SAISAI_FOLDER, 'model');
...
*/
	...
	public function relationship_field_names($relationship_type)
	{
		...
		$fields = array(
			...
			'relationships_model'=> array(SAISAI_FOLDER => 'saisai_relationships_model'),
			);
	...
	public function load_custom_field_classes($folder = 'libraries/custom_fields')
	{
		...
		foreach($this->custom_fields as $field => $custom_class)
		{
			...
			else
			{
				...
				// check the SAISAI folder if it doesn't exist
				if (!file_exists($class_path))
				{
					$class_path = MODULES_PATH.SAISAI_FOLDER.'/'.$folder.'/'.$m.EXT;
				}
			}
...
/* Location: ./modules/saisai/core/MY_Model.php */
