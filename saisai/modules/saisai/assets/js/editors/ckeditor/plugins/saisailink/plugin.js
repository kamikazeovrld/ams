...
CKEDITOR.plugins.add( 'saisailink', {
	...
	init: function( editor ) {
		editor.on( 'doubleclick', function( evt )
        {
           ...
           if ( element.is( 'a' ) && !element.getAttribute( '_cke_realelement' )){
				editor.execCommand('saisailink');
           }
           
        }, null,null,100);
		// Define an editor command that opens our dialog.
		editor.addCommand( 'saisailink', {
		 ...
		 editor.on( 'selectionChange', function( evt )
			{
				 ...
				 */
				var command = editor.getCommand( 'saisaiunlink' ),
    	...
    	// Define an editor command that opens our dialog.
		editor.addCommand( 'saisaiunlink', {
	        exec: function( editor ) {
