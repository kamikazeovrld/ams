...
<div class="jqmWindow jqmWindowShow warning" id="change_pwd_notification">
	<div class="modal_content_inner">
		<p><?=lang('warn_change_default_pwd', $this->config->item('default_pwd', 'saisai'))?></p>
		<div class="buttonbar" id="yes_no_modal" style="width: 364px;">
			<ul>
				...
				<li class="unattached"><a href="<?=saisai_url('my_profile/edit/')?>" class="ico ico_yes" id="change_pwd_go"><?=lang('dashboard_change_pwd')?></a></li>
			</ul>
		</div>
		<div class="clear"></div>
	</div>
