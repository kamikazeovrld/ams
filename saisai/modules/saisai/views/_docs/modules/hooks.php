<h1>Module Hooks</h1>
<p>SAISAI has extended the <a href="http://ellislab.com/codeigniter/user-guide/general/hooks.html" target="_blank">CodeIgniter Hooks</a> system to provide
...
in your advanced module folders (e.g. <dfn>saisai/modules/my_module/hooks</dfn>). To add a hook, you modify the <dfn>saisai/application/config/hooks.php</dfn>
...
<p>The following is an example of an advanced module named "projects" that has a hook file located at <dfn>saisai/modules/projects/hooks/Project_hooks.php</dfn>.</p>
...
For example, say you want to integrate into the SAISAI blog comment module to send an email notification to someone other then the author of the post (which the blog
module does automatically). You can add an <dfn>after_edit_blog_comments</dfn> hook to the <dfn>saisai/application/config/hooks.php</dfn> file to make that happen.
</p>