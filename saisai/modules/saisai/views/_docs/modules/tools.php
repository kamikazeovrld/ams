<h1>Module Tools</h1>
<p>New to SAISAI CMS 1.0 is the ability to create advanced module tools that can be accessed from the <a href="<?=user_guide_url('general/inline-editing')?>">inline editing toolbar</a> to perform certain actions.
