<h1>Views</h1>
<p>Views within SAISAI work just like <a href="http://ellislab.com/codeigniter/user-guide/general/views.html" target="_blank">CodeIgniter views</a> but with some extra functionality.
...
<h2>Hiding Views</h2>
<p>You can hide view files from several aspects of SAISAI by adding an underscore (<strong>"_"</strong>) in front of the view name or containing folder. This will automatically hide it from being found
...
<ul>
	<li><strong>_admin</strong>: contains CMS admin specific views. The application folder uses this folder to hold the <dfn>_saisai_preview.php</dfn>
