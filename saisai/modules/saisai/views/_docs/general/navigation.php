<h1>Navigation</h1>
<p>Navigation in SAISAI CMS can be used to create various parent/child hierarchical menu structures such as dropdown menus, collapsible menus, breadcrumbs, site maps and page titles.</p>

<p>Programmatically, you can use the <a href="<?=user_guide_url('helpers/saisai_helper#func_saisai_nav')?>">saisai_nav</a> helper function to render those structures
or you can access the instantiated <a href="<?=user_guide_url('libraries/saisai_navigation')?>">Saisai_navigation</a> object like so:</p>
<pre class="brush:php">
// short way
echo saisai_nav(array('render_type' => 'breadcrumb'));

// long way 
echo $this->saisai->navigation->render(array('render_type' => 'page_title'));

// additional shortcuts
echo $this->saisai->navigation->basic(); // default
echo $this->saisai->navigation->breadcrumb();
echo $this->saisai->navigation->collapsible();
echo $this->saisai->navigation->page_title();
echo $this->saisai->navigation->delimited();
echo $this->saisai->navigation->data();
</pre>

<h2>Navigation Structures</h2>
<p>There are two ways to create navigation structures in SAISAI. The first way, is to create a
<dfn>$nav</dfn> array in the file located at <span class="file">saisai/applicaiton/views/_variables/nav.php</span> like below:</p>
 
<span class="file">saisai/application/views/_variables/nav.php</span>
<pre class="brush: php">
$nav['about'] = 'About';
...
<p>The second way, is to input that information in the CMS. Alternatively, you can upload a nav file (<span class="file">saisai/application/views/_variables/nav.php</span>) in the CMS to save you some input time.
By default, the <dfn>saisai_nav()</dfn> function will first check to see if there is any navigation items saved if the CMS is being used, and if not will use the
<span class="file">nav.php</span> file.</p>

<p class="important">Although SAISAI provides a way for you to create a navigation item when creating a page,
it's important to note that navigation in SAISAI is not directly associated with pages which can give you greater flexibility in your structures.</p>

<h2>Usage Examples</h2>
<p>The most common way to render a navigation structure is to use the <a href="<?=user_guide_url('helpers/saisai_helper#func_saisai_nav')?>">saisai_nav()</a> function which is a wrapper around the
...
<pre class="brush: php">
...
$vars[&#x27;page_title&#x27;] = saisai_nav(array(&#x27;render_type&#x27; =&gt; &#x27;page_title&#x27;, &#x27;delimiter&#x27; =&gt; &#x27; : &#x27;, &#x27;order&#x27; =&gt; &#x27;desc&#x27;, &#x27;home_link&#x27; =&gt; &#x27;WidgiCorp - Fine Makers of Widgets&#x27;));
...
</pre>
...
<pre class="brush: php">
...
&lt;?php echo saisai_nav(array(&#x27;container_tag_id&#x27; =&gt; &#x27;topmenu&#x27;, &#x27;item_id_prefix&#x27; =&gt; &#x27;topmenu_&#x27;)); ?&gt;
...
</pre>
...
<p>The side menu works very similar to the top menu. You can set a variable of <dfn>$sidemenu</dfn> using the <dfn>saisai_nav()</dfn> function again.
Alternatively, you could simply use <dfn>saisai_nav()</dfn> in your layout file. In some cases, you may want to include <dfn>container_tag_id</dfn> parameter like the top menu, but you also include the <dfn>parent_id</dfn> in which to render from. For example, if you have a menu structure that
...
<span class="file">application/views/_variables/global.php (example)</span>
<pre class="brush: php">
$vars[&#x27;sidemenu&#x27;] = saisai_nav(array(&#x27;container_tag_id&#x27; =&gt; &#x27;sidemenu&#x27;, &#x27;parent&#x27; =&gt; uri_segment(1)));
</pre>

<p>You can merge the <dfn>$sidemenu</dfn> variable in using a normal merge in your layouts. 
You do not use the <a href="<?=user_guide_url('helpers/saisai_helper')?>" target="_blank">saisai_var()</a> function because it is not an editable variable:</p>
...
<span class="file">application/views/_variables/global.php (example)</span>
<pre class="brush: php">
$vars[&#x27;footermenu&#x27;] = saisai_nav(array(&#x27;container_tag_id&#x27; =&gt; &#x27;footermenu&#x27;, &#x27;render_type&#x27; =&gt; 'delimited'));
</pre>
...
<h3>sitemap.xml</h3>
<p>Hopefully, you are starting to see the benefits of creating your menu structures in this format. The last thing we'll cover is creating the sitemap.xml. SAISAI comes with a
sitemap.xml view that you can use. You will need to uncomment the line in the <span class="file">saisai/application/config/routes.php</span> file for it to work. You will
...
$nav = saisai_nav(array(&#x27;return_normalized&#x27; =&gt; TRUE));

/***************************************************************
Add any dynamic pages and associate them to the $nav array here:
**************************************************************/

$projects = saisai_model('projects'); // won't filter on published because they all should be'
...
<p>Here, we again use the <dfn>saisai_nav()</dfn> function to create the <dfn>$nav</dfn> array variable. We then add to that <dfn>$nav</dfn> array
