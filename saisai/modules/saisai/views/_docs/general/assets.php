...
<p>SAISAI provides a way to optimize JS and CSS files by condensing their output into a single file. This can be done "on the fly" by changing the
...
<br />
<p>Alternatively, you can generate these files via command line by using SAISAI's "build" functionality like so:</p>
<pre class="brush:php">
// js
&gt;php index.php saisai/build/app/js/plugins:plugins

// css
&gt;php index.php saisai/build/app/css/plugins:plugins
</pre>
