...
<p>SAISAI CMS initially comes with a single "super admin" user. This user is not assigned permissions because they automatically have permissions for everything.
...
<a href="https://github.com/imknight/SAISAI-CMS-Modules" target="_blank">imknight's module</a>.</p>
...
<p>Each simple module in the CMS should have a permission created for it. When configuring your module in the <span class="file">saisai/application/config/MY_saisai_modules.php</span>,
...
<p>If you are a "Super Admin" user, meaning that you have the "super_admin" field set to yes in the saisai_users table, you will see an additional action in the list view next to other user name
