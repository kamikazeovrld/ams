...
named <dfn>page_router</dfn>. This controller will do one of two things, depending on the <dfn>saisai_mode</dfn> value set in the SAISAI config file:
</p>

<ol>
	<li>render pages saved in the saisai database (not what we are doing here)</li>
...
saisai helper function <dfn>saisai_set_var</dfn>. By setting the varialbe this way, you will ensure that the variable will also get
passed to the layout file containing the view file.
</p>

<pre class="brush:html">
&lt;?php saisai_set_var('page_title', 'About : My Website'); ?&gt;
...
class About extends CI_Controller {
	...
	function contact()
	{
		...
		// use Saisai_page to render so it will grab all opt-in variables and do any necessary parsing
