...
Use the <a href="<?=user_guide_url('helpers/saisai_helper')?>">saisai_var</a> function in your views to merge in a global variable
or ({saisai_var('varname')} in a form field that doesn't allow PHP).
</p>