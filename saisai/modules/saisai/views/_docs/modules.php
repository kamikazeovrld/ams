<h1>Modules</h1>
<p>Modules are a way for you to extend the functionality of SAISAI.
...
In fact, SAISAI is no more then an advanced module itself.</p>
...
<h2>Installation</h2>
<p>One of the bigger changes in SAISAI v1.0 was the removal of all the extra bundled advanced modules. The reason was to keep the initial SAISAI install
...
The first is to use GIT to add a <a href="http://git-scm.com/book/en/Git-Tools-Submodules" target="_blank">submodule</a> to your installation in your <span class="file">saisai/modules/{module}</span> folder.
Adding the advanced module as a GIT submodule will allow you to run updates independent of your main SAISAI CMS repository.
Adding a submodule can be done one of two ways. The first way uses the native "submodule" command from GIT, and the second uses the SAISAI installer "add_get_submodule" controller method.
...
installation directory (where the index.php CodeIgniter bootstrap file exists alongside the "saisai" folder). Then run the commands below where "php" references the path to your PHP interpreter.</p>

<pre class="brush: php">
// GIT
&gt;php git submodule add git://github.com/daylightstudio/SAISAI-CMS-Blog-Module.git saisai/modules/blog

// SAISAI
&gt;php index.php saisai/installer/add_git_submodule git://github.com/daylightstudio/SAISAI-CMS-Blog-Module.git blog
</pre>
...
<p>After adding the folder to your <span class="file">saisai/modules</span> folder either manually or via GIT, you may need to finalize the istallation by running some
additional SQL statements. These SQL statements can be found in your modules "install" folder. SAISAI provides a simpler way to install both the SQL and any necessary permissions
...
<pre class="brush: php">
&gt;php index.php saisai/installer/install blog
</pre>
...
<pre class="brush: php">
&gt;php index.php saisai/installer/uninstall blog
</pre>
...
<span class="file">saisai/modules/blog/install/install.php</span>
<pre class="brush: php">
...
$config['description'] = 'The SAISAI Blog Module can be used to create posts and allow comments in an organized manner on your site.';
$config['compatibility'] = '1.0';
$config['instructions'] = '';
$config['permissions'] = array('blog/posts', 'blog/comments', 'blog/categories', 'blog/users');
$config['migration_version'] = 0;
$config['install_sql'] = 'saisai_blog_install.sql';
$config['uninstall_sql'] = 'saisai_blog_uninstall.sql';
$config['repo'] = 'git://github.com/daylightstudio/SAISAI-CMS-Blog-Module.git';
</pre>
