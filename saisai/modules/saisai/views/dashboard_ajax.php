<?php if ($this->saisai->auth->has_permission('logs')) : ?>
...
<div class="dashboard_pod" style="width: 400px;">
	...
	<a href="<?=saisai_url('logs')?>"><?=lang('dashboard_view_all_activity')?></a>
</div>
<?php endif; ?>
<?php endif; ?>
...
<div class="dashboard_pod" style="width: 230px;">
	...
	<a href="<?=$this->config->item('dashboard_rss', 'saisai')?>"><?=lang('dashboard_subscribe_rss')?></a>
</div>
<?php endif; ?>
...
<div class="dashboard_pod" style="width: 230px;">
	<h3><?=lang('dashboard_hdr_modified')?></h3>
		<ul class="nobullets">
			...
			<li><a href="<?=saisai_url('pages/edit/'.$val['id'])?>"><?=$val['location']?></a></li>
			<?php endforeach; ?>
		</ul>
		<a href="<?=saisai_url('pages')?>"><?=lang('dashboard_view_all_pages')?></a>
</div>
<?php endif; ?>


<?php if (!empty($docs) AND $this->saisai->auth->has_permission('site_docs')) : ?>
<div class="dashboard_pod" style="width: 230px;">
