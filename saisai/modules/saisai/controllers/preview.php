...
class Preview extends Saisai_base_controller {
	...
	public function index()
	{
		...
		// don't want to saisaiify'
		define('SAISAIIFY', FALSE);
		...
		*/
		...
		else if (file_exists(APPPATH.'views/_admin/_saisai_preview'.EXT))
		{
			$view = $this->load->view('_admin/_saisai_preview', $vars, TRUE);
		}
