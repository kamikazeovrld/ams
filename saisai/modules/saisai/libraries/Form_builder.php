 ...
 * 
 * Custom form fields can be configured in the <span class="file">saisai/application/config/custom_fields.php</span> file.
 *
 ...
 * @category	Libraries
 * @author		David McReynolds @ Daylight Studio
 * @link		http://docs.getsaisaicms.com/libraries/form_builder
 */
...
class Form_builder {
	...
	/**
	 * Creates the multi select input for the form (this is overwritten by the Saisai_custom_fields to give more functionaltity)
	 *
	 * @access	public
	 * @param	array fields parameters
	 * @return	string
 ...
 * @category	Libraries
 * @author		David McReynolds @ Daylight Studio
 * @link		http://docs.getsaisaicms.com/libraries/form_builder.html
 * @autodoc		FALSE
 */
...
/* Location: ./modules/saisai/libraries/Form_builder.php */
