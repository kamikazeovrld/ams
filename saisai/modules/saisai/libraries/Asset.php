 ...
 * @category	Libraries
 * @author		David McReynolds @ Daylight Studio
 * @link		http://docs.getsaisaicms.com/libraries/asset
 */
...
class Asset {
	...
	// module assets path 
	public $assets_module_path = 'saisai/modules/{module}/assets/';
	...
	// /saisai/modules/my_module/assets/images/banner.jpg (assuming /saisai/modules is where the module folder is located)
	...
	// http://www.mysite.com/saisai/modules/my_module/assets/images/banner.jpg (if the "assets_module" Asset class property is my_module)
	...
	// /saisai/modules/my_module/assets/css/main.css (assuming /saisai/modules is where the module folder is located)
	...
	// /saisai/modules/my_module/assets/js/main.js (assuming /saisai/modules is where the module folder is located)
	...
	// /saisai/modules/my_module/assets/swf/home.swf (assuming /saisai/modules is where the module folder is located)
	...
	// /saisai/modules/my_module/assets/pdf/newsletter.pdf (assuming /saisai/modules is where the module folder is located)
	...
	// /saisai/modules/my_module/assets/media/nmymovie.mov (assuming /saisai/modules is where the module folder is located)
	...
	// /saisai/modules/my_module/assets/docs/mydoc.doc (assuming /saisai/modules is where the module folder is located)
	...
	// /saisai/modules/my_module/assets/cache/3c38643da81c3cee289feac34465c353_943948800.php (assuming /saisai/modules is where the module folder is located)
	...
	// /saisai/modules/my_module/assets/captcha/123456_captcha.jpg (assuming /saisai/modules is where the module folder is located)
	...
	echo $this->asset->assets_path('banner.jpg', 'images', 'my_module');
	// /Library/WebServer/Documents/saisai/modules/my_module/assets/images/banner.jpg (assuming /saisai/modules is where the module folder is located)
	</code>
	...
	// &lt;script src="/saisai/modules/my_module/assets/js/jquery.js" type="text/javascript" charset="utf-8"&gt;&lt;/script&gt;
	...
	// &lt;link href="saisai/modules/my_module/assets/css/main.css" media="all" rel="stylesheet"/&gt;
...
/* Location: ./modules/saisai/libraries/Asset.php */