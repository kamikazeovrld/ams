 ...
 * SAISAI base library
 * 
 * This class is the base class that many other SAISAI objects inherit from.
 *
 * @package		SAISAI CMS
 * @subpackage	Libraries
 * @category	Libraries
 * @author		David McReynolds @ Daylight Studio
 * @link		http://docs.getsaisaicms.com/libraries/saisai_base_library
 */

// --------------------------------------------------------------------

class Saisai_base_library {
	
	protected $CI = NULL; // reference to the CI super object
	protected $saisai = NULL; // reference to the saisai object
	...
	protected function _has_permission()
	{
		...
		{
			if (!$this->saisai->auth->has_permission($this->permission))
			{
				return FALSE;
			}
		}
...
/* End of file Saisai_base_library.php */
/* Location: ./modules/saisai/libraries/Saisai_base_library.php */