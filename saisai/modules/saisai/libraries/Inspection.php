 ...
 * @category	Libraries
 * @author		Jabulani Mpofu @ Saisai
 * @link		http://docs.saisai.co/libraries/inspection
 */
...
class Inspection_comment {
	...
	public function initialize($comment)
	{
		...
		$tags = array(
			...
			"tutorial"	=>	'',
			"version"	=>	'',
			"prefix"	=>	'', // specific to SAISAI documentation
			"autodoc"	=>	'', // specific to SAISAI documentation
		);
		$this->tags = $tags;
...
/* Location: ./modules/saisai/libraries/Inspection.php */