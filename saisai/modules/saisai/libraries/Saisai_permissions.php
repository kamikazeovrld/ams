...
/**
 * SAISAI permissions object
 *
 * @package		SAISAI CMS
 * @subpackage	Libraries
 * @category	Libraries
 * @author		David McReynolds @ Daylight Studio
 * @link		http://docs.getsaisaicms.com/libraries/saisai_permissions
 */

// --------------------------------------------------------------------

class Saisai_permissions extends Saisai_module {
...
/* End of file Saisai_permissions.php */
/* Location: ./modules/saisai/libraries/Saisai_permissions.php */