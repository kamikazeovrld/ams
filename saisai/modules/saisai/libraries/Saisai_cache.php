 ...
 * with SAISAI including pages, compiled templates and asset files.
 *
 * @package		SAISAI CMS
 * @subpackage	Libraries
 * @category	Libraries
 * @author		David McReynolds @ Daylight Studio
 * @link		http://docs.getsaisaicms.com/libraries/saisai_cache
 */

// --------------------------------------------------------------------

class Saisai_cache extends Saisai_base_library {
	 ...
	 * 
	 * <code>
	 * $cache_id = $this->saisai->cache->create_id(); // create a cache id... this will be based on the current URI location if no parameters are passed
	 * </code>
	 *
	 * @access	public
	...
	{
		$lang = ($this->saisai->language->has_multiple()) ? $this->saisai->language->detect() : $this->saisai->language->default_option();
		if (empty($location))
		{
	 ...
	 * $file = $this->saisai->cache->save($cache_id, $data, NULL, 3600); // sets the cached item with a TTL of one hour
	 * </code>
	 *
	 * @access	public
	 ...
	 * <code>
	 * $cache_id = $this->saisai->cache->create_id();
	 * $file = $this->saisai->cache->get($cache_id, 'pages', FALSE);
	 * </code>
	 *
	 * @access	public
	 * @param	string	Cache ID
	 ...
	 * <code>
	 * $cache_id = $this->saisai->cache->create_id();
	 * if ($this->saisai->cache->is_cached($cache_id)){
	 *  	echo 'cached';
	 *  } else {
	 *  	echo 'not cached';
	 *  } 
	 ...
	 * 
	 * <code>
	 * $this->saisai->cache->clear(array('compiled', 'pages')); // as an array
	 * $this->saisai->cache->clear('assets'); // as string
	 * </code>
	 *
	 * @access	public
	 ...
	 * 
	 * <code>
	 * $this->saisai->cache->clear_page('about/history');
	 * </code>
	 *
	 * @access	public
	 ...
	 * 
	 * Will look in module asset folders if the <dfn>saisai/{module}/assets/cache/</dfn> directory exist for that module
	 * 
	 * <code>
	 * $this->saisai->cache->clear_assets();
	 * </code>
	 *
	 * @access	public
	 * @return	void
	 ...
	 * <code>
	 * $cache_id = $this->saisai->cache->create_id();
	 * $this->saisai->cache->clear_file($cache_id);
	 * </code>
	 *
	 * @access	public
	 * @param	string	Cache ID
	 ...
	 * <code>
	 * $group = 'pages';
	 * $this->saisai->cache->clear_group($group);
	 * </code>
	 * 
	 * @access	public
	 * @param	string	Cache group ID
	 ...
	 * 
	 * <code>
	 * $this->saisai->cache->clear_all_modules();
	 * </code>
	 * 
	 * @access	public
	 * @return	void
	...
	{
		$modules = $this->CI->saisai->config('modules_allowed');
		foreach($modules as $module)
		{
...
/* End of file Saisai_cache.php */
/* Location: ./modules/saisai/libraries/Saisai_cache.php */