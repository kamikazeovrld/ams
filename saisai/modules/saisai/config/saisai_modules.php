...
$config['modules']['pages'] = array(
	'module_name' => 'Pages',
	'model_location' => 'saisai',
	'model_name' => 'saisai_pages_model',
	...
	'default_order' => 'asc',
	'js_controller' => 'saisai.controller.PageController',
...
$config['modules']['pagevariables'] = array(
	...
	'model_location' => 'saisai',
	'model_name' => 'saisai_pagevariables_model',
	'display_field' => 'name',
	'table_headers' => array(
		'id', 
		'location', 
...
$config['modules']['navigation'] = array(
	...
	'model_location' => 'saisai',
	'model_name' => 'saisai_navigation_model',
	'display_field' => 'label',
	'default_col' => 'nav_key',
	'default_order' => 'asc',
	'js_controller' => 'saisai.controller.NavigationController',
	'preview_path' => '',
	...
	'filters' => array('group_id' => array('default' => 1, 'label' => lang('form_label_navigation_group'), 'type' => 'select', 'model' => 'saisai_navigation_groups_model', 'hide_if_one' => TRUE)),
	'archivable' => TRUE,
...
$config['modules']['navigation_group'] = array(
	...
	'model_location' => 'saisai',
	'model_name' => 'saisai_navigation_groups_model',
	'table_headers' => array(
		'id', 
		'name', 
		'published',
...
$config['modules']['tags'] = array(
	...
	//'filters' => array('context' => array('label' => lang('form_label_category'), 'type' => 'select', 'model' => 'saisai_categories_model', 'first_option' => '')),
);
...
$config['modules']['categories'] = array(
	...
	'model_location' => 'saisai',
	'model_name' => 'saisai_categories_model',
	'table_headers' => array(
		'id', 
		'name', 
		'slug',
	...
	'filters' => array('context' => array('label' => lang('form_label_context'), 'type' => 'select', 'model' => array(SAISAI_FOLDER => array('saisai_categories_model' => 'context_options_list')), 'first_option' => 'Select a context...')),
);
...
$config['modules']['assets'] = array(
	'module_name' => 'Assets',
	'model_location' => 'saisai',
	'model_name' => 'saisai_assets_model',
	'table_headers' => array(
		'id',
		'name', 
		'preview/kb', 
	...
	'default_col' => 'name',
	'default_order' => 'asc',
	'js_controller' => 'saisai.controller.AssetsController',
	'display_field' => 'name',
	'preview_path' => '',
	'permission' => 'assets',
...
$config['modules']['sitevariables'] = array(
	...
	'model_location' => 'saisai',
	'model_name' => 'saisai_sitevariables_model',
	'table_headers' => array(
		'id', 
		'name', 
		'value', 
...
$config['modules']['users'] = array(
	...
	'js_controller' => 'saisai.controller.UserController',
	'display_field' => 'email',
	'preview_path' => '',
	'permission' => 'users',
	...
	'table_actions' => array(
		...
		'DELETE' => array(
			'func' => create_function('$cols', '
				if ($cols[\'super_admin\'] != "yes") { 
					$CI =& get_instance();
					$link = "";
					if ($CI->saisai->auth->has_permission($CI->permission, "delete") AND isset($cols[$CI->model->key_field()]))
					{
						$url = site_url("/".$CI->config->item("saisai_path", "saisai").$CI->module_uri."/delete/".$cols[$CI->model->key_field()]);
		...
		'LOGIN' => array(
			'func' => create_function('$cols', '
				...
				if ($CI->saisai->auth->is_super_admin() AND ($cols[$CI->model->key_field()] != $user["id"]))
				{
					$url = site_url("/".$CI->config->item("saisai_path", "saisai").$CI->module_uri."/login_as/".$cols[$CI->model->key_field()]);
...
$config['modules']['permissions'] = array(
	...
	'model_location' => 'saisai',
	'model_name' => 'saisai_permissions_model',
	'table_headers' => array(
		'id', 
		'description', 
		'name', 
...
/* Location: ./modules/saisai/config/saisai_modules.php */