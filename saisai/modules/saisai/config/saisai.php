...
// path to the saisai admin from the web base directory... MUST HAVE TRAILING SLASH!
$config['saisai_path'] = SAISAI_FOLDER.'/';
...
// used for system emails. Can be overwritten by MY_saisai.php
$config['domain'] = $_SERVER['SERVER_NAME'];

// the page to redirect to AFTER logging in
$config['login_redirect'] = $config['saisai_path'].'dashboard';

// the page to redirect to AFTER logging out. . Use the special value :last to redirect to the last page you were on.
//$config['logout_redirect'] = $config['saisai_path'].'login'; // to take you back to the login page instead of the last page you were on
...
$config['saisai_cookie_path'] = WEB_PATH;

// external css file for additional styles possibly needed for 3rd party integration and customizing.
// must exist in the assets/css file and not the saisai/assets/css folder
$config['xtra_css'] = '';

// the main layout file to be used for the interface.
// By default, it will pull from the saisai module folder however, if an array is specified, the key will be the module and the value will be the view file.
...
// an associative array of objects to attach to the saisai object
$config['attach'] = array();
...
// paths specific to SAISAI... relative to the WEB_ROOT
$config['saisai_assets_path'] = 'saisai/modules/{module}/assets/';
...
$config['saisai_javascript'] = array(
/*
	'saisai' => array(
	...
	'saisai' => 'saisai/saisai.min'
);


// css other then the saisai.css file which automatically gets loaded
$config['saisai_css'] = array();
...
$config['saisai_assets_output'] = FALSE;
...
// restrict saisai to only certain ip addresses (can be string or an array of IP addresses)
$config['restrict_to_remote_ip'] = array();

// restrict saisai webhooks like the migrate functionality to only certain IP address (can be string or an array of IP addresses)
$config['webhook_remote_ip'] = array();

// default password to alert against
$config['default_pwd'] = 'admin';

// enable the SAISAI admin or not?
...
// specifies which modules are allowed to be used in the SAISAI admin (e.g. 'user_guide', 'blog', 'backup'...)
...
// my modules... if set to empty array, then it will automatically include all in MY_saisai_modules.php
...
// the SAISAI specific database tables
$config['tables'] = array(
	'saisai_archives'            => 'saisai_archives',
	'saisai_blocks'              => 'saisai_blocks',
	'saisai_categories'          => 'saisai_categories',
	'saisai_logs'                => 'saisai_logs',
	'saisai_navigation'          => 'saisai_navigation',
	'saisai_navigation_groups'   => 'saisai_navigation_groups',
	'saisai_pages'               => 'saisai_pages',
	'saisai_pagevars'            => 'saisai_page_variables',
	'saisai_permissions'         => 'saisai_permissions',
	'saisai_relationships'       => 'saisai_relationships',
	'saisai_settings'            => 'saisai_settings',
	'saisai_tags'                => 'saisai_tags',
	'saisai_users'               => 'saisai_users',
	);
...
// will be activated if saisai_set_var is called from within a block or page
...
@include(APPPATH.'config/MY_saisai.php');
...
/* Location: ./modules/saisai/config/saisai.php */