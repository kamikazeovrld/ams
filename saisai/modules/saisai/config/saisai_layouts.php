...
| a new layout in the SAISAI page admin. The key (e.g. 'header') is associated
...
@include(APPPATH.'config/MY_saisai_layouts.php');
...
/* Location: ./modules/saisai/config/saisai_layouts.php */