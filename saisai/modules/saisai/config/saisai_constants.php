...
define('SAISAI_VERSION', '1.1');
define('MODULES_FOLDER', '../modules');
define('SAISAI_FOLDER', 'saisai');
define('MODULES_PATH', APPPATH.MODULES_FOLDER.'/');
define('MODULES_FROM_APPCONTROLLERS', '../'.MODULES_FOLDER.'/');
define('SAISAI_PATH', MODULES_PATH.SAISAI_FOLDER.'/');
...
$_SAISAI_SEGS = explode('/', str_replace("\\", '/', $_SERVER['SCRIPT_FILENAME']));

define('WEB_FOLDER', (count($_SAISAI_SEGS) > 1) ? $_SAISAI_SEGS[count($_SAISAI_SEGS)-2] : '/');
define('MODULES_WEB_PATH', SAISAI_FOLDER.'/modules/');
...
define('SAISAI_ROUTE', $config['saisai_path']);
...
define('USE_SAISAI_ROUTES', (strpos($_URI_PATH, '/'.$config['saisai_path']) !== FALSE));
...
/* End of file saisai_constants.php */
/* Location: ./modules/saisai/config/saisai_constants.php */