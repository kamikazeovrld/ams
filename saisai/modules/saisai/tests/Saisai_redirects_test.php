...
class Saisai_redirects_test extends Saisai_test_base {
	...
	{
		$this->saisai->redirects->add('test1', 'home', FALSE);
		$test = $this->saisai->redirects->aggressive_redirects;
	...
	{
		$this->saisai->redirects->add('test1', 'home', TRUE);
		$test = $this->saisai->redirects->passive_redirects;
		$expected = array('test1' => 'home');
