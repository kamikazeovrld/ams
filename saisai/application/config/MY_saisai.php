...
/*
|---------------------------------------------------------------------------------------------------
| IMPORTANT: for a complete list of saisai configurations, go to the modules/saisai/config/saisai.php file
|---------------------------------------------------------------------------------------------------
*/
...
$config['ck_editor_settings'] = "{
	...
	entities: false,
	bodyClass: 'ckeditor',
	protectedSource: [/\{saisai_\w+\(.+\)\}/g, /<\?[\s\S]*?\?>/g],
	toolbarCanCollapse: false,
	extraPlugins: 'saisailink,saisaiimage',
	removePlugins: 'link,image'
	}";

/* Uncomment if you want to control SAISAI settings in the CMS. Below are a couple examples of ones you can configure
...
/* End of file MY_saisai.php */
/* Location: ./application/config/MY_saisai.php */