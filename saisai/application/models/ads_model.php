...
class Ads_model extends Base_module_model {

	// read more about models in the user guide to get a list of all properties. Below is a subset of the most common:

	public $record_class = 'Ad'; // the name of the record class (if it can't be determined)
	...
	public $foreign_keys = array('advertiser_id' => 'advertisers_model', 'poll_id' => 'polls_model', 'textmatch_id' => 'textmatchs_model', 'clicktovisit_id' => 'clicktovisits_model'); // map foreign keys to table models
	...
	{
		parent::__construct('ads'); // table name
	}

	function list_items($limit = NULL, $offset = NULL, $col = 'createdDate', $order = 'desc', $just_count = FALSE)
	{
...
class Ad_model extends Base_module_record {
