...
class Advertisers_model extends Base_module_model {

	// read more about models in the user guide to get a list of all properties. Below is a subset of the most common:

	public $record_class = 'Advertiser'; // the name of the record class (if it can't be determined)
	...
	{
		parent::__construct('advertisers'); // table name
	}

	function list_items($limit = NULL, $offset = NULL, $col = 'createDate', $order = 'desc', $just_count = FALSE)
	{
...
class Advertiser_model extends Base_module_record {
