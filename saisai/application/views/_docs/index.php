...
<ul>
	...
	<li><strong>Manage</strong> - The following modules are used to manage various aspects of the site:
		<ul>
			<li><strong><a href="#users">Users</a></strong> - allows you to create and manage permissions of SAISAI CMS users.</li>
			...
			<li><strong>Activity Log</strong> - allows you to view the activity logs within SAISAI CMS.</li>
...
<?php $modules = $this->saisai->modules->advanced();?>
<ul>
...
<h2 id="dashboard" class="ico ico_dashboard"><img src="<?=img_path('icons/ico_house.png', 'saisai')?>" alt="Dashboard" /> <a href="<?=saisai_url('dashboard')?>">Dashboard</a></h2>
<p>The SAISAI CMS dashboard displays the latest activity within the system, SAISAI news as well as a link to this documentation. </p>
...
<p>Layouts are predefined HTML files located in the <dfn><?=APPPATH?>views/_layouts</dfn> folder and are used for placing content in your site pages.
	Each layout is associated with a set of fields that can be edited when creating a page which is found in the <dfn><?=APPPATH?>config/MY_saisai_layouts.php</dfn>.
...
<ul>
	<?php $layouts = $this->saisai->layouts->get(); ?>
...
<?php if ($this->saisai->config('text_editor') == 'markitup') : ?>
<h3>Inputting HTML Text</h3>
<p>For the fields that require large amounts of text, SAISAI provides a textarea with controls that allow you to quickly insert HTML code. Mousing over the controls will
provide tooltips as to what each control will add to your content field.
 ...
 editing space, you can click the full screen button <img src="<?=img_path('markitup/minimize.png', 'saisai')?>" alt="minimize" /> to expand the editing region. Lastly,
...
Then you can browse your site and you will notice a small icon in the upper right corner that looks like <img src="<?=img_path('icons/ico_saisai.png', 'saisai')?>" alt="SAISAI" />.
Clicking on <img src="<?=img_path('icons/ico_saisai.png', 'saisai')?>" alt="SAISAI" /> (SAISAI icon) will expand a contextual menu depending on the type of page. If inline editable areas are available on the page, you will see a <img src="<?=img_path('icons/ico_pencil.png', 'saisai')?>" alt="SAISAI" />
...
<h2 id="blocks" class="ico ico_blocks"><img src="<?=img_path('icons/ico_application_view_tile.png', 'saisai')?>" alt="Layouts" /> <a href="<?=saisai_url('blocks')?>">Blocks</a></h2>
...
<h2 id="navigation" class="ico ico_navigation"><img src="<?=img_path('icons/ico_sitemap_color.png', 'saisai')?>" alt="Layouts" /> <a href="<?=saisai_url('navigation')?>">Navigation</a></h2>
...
<h2 id="tags" class="ico ico_tags"><img src="<?=img_path('icons/ico_tag_blue.png', 'saisai')?>" alt="Layouts" /> <a href="<?=saisai_url('tags')?>">Tags</a></h2>
...
<h2 id="categories" class="ico ico_categories"><img src="<?=img_path('icons/ico_folder_page.png', 'saisai')?>" alt="Layouts" /> <a href="<?=saisai_url('categories')?>">Categories</a></h2>
...
<h2 id="assets" class="ico ico_assets"><img src="<?=img_path('icons/ico_pictures.png', 'saisai')?>" alt="Layouts" /> <a href="<?=saisai_url('assets')?>">Assets</a></h2>
...
<h2 id="sitevariables" class="ico ico_sitevariables"><img src="<?=img_path('icons/ico_page_white_code.png', 'saisai')?>" alt="Layouts" /> <a href="<?=saisai_url('sitevariables')?>">Site Variables</a></h2>
...
<h2 id="users" class="ico ico_users"><img src="<?=img_path('icons/ico_key.png', 'saisai')?>" alt="Layouts" /> <a href="<?=saisai_url('users')?>">Users &amp; Permissions</a></h2>
<p>SAISAI CMS users are created in the users module in the admin. A single user can subscribe to as many permissions as necessary however, the permissions to manage users and permisisons
gives a user admin level control so use wisely. Furthermore, certain permissions may not be applicable to your setup.</p>

<h2 id="cache" class="ico ico_manage_cache"><img src="<?=img_path('icons/ico_page_lightning.png', 'saisai')?>" alt="Layouts" /> <a href="<?=saisai_url('manage/cache')?>">Page Cache</a></h2>
<p>SAISAI CMS uses a cache to speed up the delivery of pages. Sometimes changes are made to static layouts or blocks and your changes may not be immediately reflected. This is most likely
related to the cache which can be <a href="<?=saisai_url('manage/cache')?>">cleared here</a>.</p>

<h2 id="settings" class="ico ico_settings"><img src="<?=img_path('icons/ico_table_gear.png', 'saisai')?>" alt="Layouts" /> <a href="<?=saisai_url('settings')?>">Settings</a></h2>
